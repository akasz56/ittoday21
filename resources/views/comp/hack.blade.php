        ...
        <section data-aos="fade-up" class="bg-blur-main competition-main">
            ...
            <div class="py-5 competition-title">
                ...
                <div class="w-75 mx-auto">
                    <img src="{{ asset('/assets/icons/logo-hack.svg') }}" alt="Logo Hacktoday" class="d-block">
                </div>
            ...
            <div class="d-flex justify-content-center competition-desc">
                <div class="mx-4">
                    ...
                    <p style="line-height: 1em;">Rizal : <a href="https://wa.me/+6289644417286"
                            target="_blank">WhatsApp</a></p>
                    <p style="line-height: 1em;">Yosar : <a href="https://wa.me/+62895342744068"
                            target="_blank">WhatsApp</a></p>
                    <p style="line-height: 1em;">Patar : <a href="https://t.me/patarisac"

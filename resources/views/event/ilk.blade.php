            ...
            <div class="ilkommunity-list">
                ...
                <div class="d-flex ilkommunity-unit">
                    <div class="info m-auto">
                        ...
                        <a href="https://loket.com/event/ilkommunity-webinar-data-mining_4UU31" class="btn btn-primary" target="_blank">Buy Ticket (Loket.com)</a>
                    </div>
                ...
                <div class="d-flex ilkommunity-unit">
                    <div class="info m-auto">
                        ...
                        <a href="https://loket.com/event/ilkommunity-webinar-game-reality_4UU33" class="btn btn-primary" target="_blank">Buy Ticket (Loket.com)</a>
                    </div>
                    <div class="d-flex justify-content-center align-items-center ilk-speakers">
                        <div class="speaker-container">
                            <div class="ilk-spk">
                ...
                <div class="d-flex ilkommunity-unit">
                    <div class="info m-auto">
                        <div class="fw-bold">Interaksi Manusia Komputer Post Pandemic di Dunia Kerja</div>
                        <p class="fw-bold fst-italic" style="color: gray;">AgriUX</p>
                        <p>Sabtu, 4 September 2021</p>
                        <a href="https://loket.com/event/ilkommunity-webinar-agriux_4UU34" class="btn btn-primary" target="_blank">Buy Ticket (Loket.com)</a>
                    </div>
                    <div class="d-flex justify-content-center align-items-center ilk-speakers">
                        <div class="speaker-container">
                            <div class="ilk-spk">
                ...
                <div class="d-flex ilkommunity-unit">
                    <div class="info m-auto">
                        ...
                        <a href="https://loket.com/event/ilkommunity-webinar-dev-talks_4UU39" class="btn btn-primary" target="_blank">Buy Ticket (Loket.com)</a>
                    </div>
                    <div class="d-flex justify-content-center align-items-center ilk-speakers">
                        <div class="speaker-container">
                            <div class="ilk-spk">
